...
import static io.quarkus.pnc.importer.rest.BuildProgress.FINISHED;
import static io.quarkus.pnc.importer.rest.BuildProgress.IN_PROGRESS;
import static io.quarkus.pnc.importer.rest.BuildProgress.PENDING;
